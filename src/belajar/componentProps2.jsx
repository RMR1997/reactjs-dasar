...
const ComponentProps2 = (props) => {
    const {textColor, text} = props;
  return (
    <>
      <div className="flex justify-center items-center mb-8">
        <h1 className={`text-5xl font-bold ${textColor} text-center mt-10`}>{text}</h1>
      ...
      <div className="flex justify-center items-center gap-x-4">
        ...
        <Button4>Login <span>lah</span> <h1>rizki</h1></Button4>
      </div>
    </>
  )
}

export default ComponentProps2
